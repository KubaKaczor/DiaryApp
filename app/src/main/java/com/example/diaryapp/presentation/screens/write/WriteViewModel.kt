...
import com.example.diaryapp.data.repository.MongoDB.updateDiary
...
class WriteViewModel @Inject constructor(
    private val dao: ImageToUploadDao,
    ...
    fun deleteDiary(
        ...
        viewModelScope.launch(Dispatchers.IO) {
            if(uiState.selectedDiaryId != null){
                val result = MongoDB.deleteDiary(id = ObjectId.Companion.from(uiState.selectedDiaryId!!))
